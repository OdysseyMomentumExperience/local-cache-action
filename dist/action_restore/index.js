...
__nccwpck_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ action_restore)
});
...
function absPath(dir) {
    return external_path_.isAbsolute(dir) ? dir : external_path_.join(process.cwd(), dir);
}
...
function restoreCache(destination, restoreKeys, cacheDir) {
    return restore_awaiter(this, void 0, void 0, function* () {
        ...
        let contents;
        try {
            contents = yield external_fs_.promises.readdir(cacheDir, { withFileTypes: true });
        }
        catch (err) {
            if (err.code !== 'ENOENT')
                throw err;
...
;// CONCATENATED MODULE: ./src/action_restore.ts
var action_restore_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
function run() {
    return action_restore_awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core.saveState("L_CACHE_EXACT" /* exactMatch */, exactMatch);
...
run();
/* harmony default export */ const action_restore = (run);
