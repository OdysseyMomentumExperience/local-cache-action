...
function saveCache(key, targetDir, cacheDir) {
    return save_awaiter(this, void 0, void 0, function* () {
        const absCacheDir = external_path_.join(absPath(cacheDir), key);
        try {
            yield external_fs_.promises.access(absCacheDir);
            core.info('Cache directory already exist, skipping.');
            return;
        }
        catch (err) {
            core.debug('Cache directory does not exist, creating.');
            yield external_fs_.promises.mkdir(absCacheDir, { recursive: true });
        }
        yield copy(targetDir, absCacheDir);
    });
}

;// CONCATENATED MODULE: ./src/action_save.ts
var action_save_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
run();
/* harmony default export */ const action_save = (run);
